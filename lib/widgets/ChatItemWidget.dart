        ...
        child: Column(
          children: <Widget> [
            Row(
              children: <Widget>[
                Container(
                  child: Text('This is sent message', style: TextStyle(color: Palette.selfMessageColor),),
            ...
            Row(
                ...
                children: <Widget>[
                  Container(
                    child: Text(DateFormat('dd MMM kk:mm').format(DateTime.fromMillisecondsSinceEpoch(1565888474278)),
                      style: TextStyle(
            ...
            Row(
              children: <Widget>[
                Container(
                  ...
                  padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                  width: 200.0,
                  decoration: BoxDecoration(color: Palette.otherMessageBackgroundColor,
                      borderRadius: BorderRadius.circular(8.0)),
